...
class TestJournalRetrieval:
    ...
    def test_journal_success_shows_source(self, qtbot):
        ...
        fake_output = "2026-03-28T12:00:00+0000 control_ofc[1234]: Started OK\n" * 5
    ...
    def test_journal_uses_correct_unit_name(self):
        """journalctl must filter by control-ofc-daemon, not control_ofc.service (R51 fix)."""
        state = _make_state()
        diag = DiagnosticsService(state)
        ...
        assert "control_ofc.service" not in args
