...
class TestMemberMinimumPct:
    def test_gpu_member_floor_is_zero_in_gpu_only_control(self):
        ...
        assert member_minimum_pct(ctrl, ctrl.members[0], frozenset()) == 0.0
    ...
    def test_gpu_member_floor_is_zero_in_mixed_chassis_control(self):
        ...
        assert member_minimum_pct(ctrl, gpu, frozenset()) == 0.0
        assert member_minimum_pct(ctrl, chassis, frozenset()) == 20.0
    ...
    def test_gpu_member_floor_is_zero_in_mixed_cpu_control(self):
        ...
        assert member_minimum_pct(ctrl, gpu, frozenset()) == 0.0
        assert member_minimum_pct(ctrl, cpu, frozenset()) == 30.0
    ...
    def test_non_gpu_member_honours_control_floor(self):
        ...
        assert member_minimum_pct(ctrl, chassis, frozenset()) == 30.0
