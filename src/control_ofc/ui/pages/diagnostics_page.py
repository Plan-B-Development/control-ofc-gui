...
from control_ofc.ui.pages.diagnostics_readiness import (
    RECLAIM_SEVERITY_HIGH,  # noqa: F401  (re-exported; tests import these from here)
    RECLAIM_SEVERITY_OK,  # noqa: F401
    RECLAIM_SEVERITY_WARN,  # noqa: F401
    classify_reclaim_severity,  # noqa: F401
    populate_hw_diagnostics,
    reclaim_severity_color,  # noqa: F401
    render_reclaim_rows,  # noqa: F401
)
...
class DiagnosticsPage(QWidget):
    ...
    def _populate_hw_diagnostics(self, diag: HardwareDiagnosticsResult) -> None:
        populate_hw_diagnostics(self, diag)
