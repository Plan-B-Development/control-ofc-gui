...
from onlyfans.constants import PAGE_DASHBOARD, POLL_INTERVAL_MS
...
from onlyfans.ui.sidebar import Sidebar
from onlyfans.ui.status_banner import StatusBanner
from onlyfans.ui.widgets.error_banner import ErrorBanner
...
class MainWindow(QWidget):
    ...
    def _on_theme_changed(self, tokens) -> None:
        ...
        from onlyfans.ui.theme import apply_theme_font, build_stylesheet
    ...
    def _open_diagnostics(self) -> None:
        from onlyfans.constants import PAGE_DIAGNOSTICS
