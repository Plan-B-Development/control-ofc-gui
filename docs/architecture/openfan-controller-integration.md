...
- **Release:** Straight back to profile control (no recovery rung since DEC-386). Every other fan the emergency took is given back at the release — an OpenFan channel to its pre-emergency duty, an hwmon header to the mode it had before the daemon took it (DEC-382)
