...
### v1.0.0 — Control-OFC → Control-OFC rebrand (BREAKING)

If you previously installed the `control_ofc`-named package, follow these migration steps:

1. Uninstall the old package: `pip uninstall control_ofc`
2. Move user config: `mv ~/.config/control_ofc ~/.config/control-ofc` (profiles, themes, settings preserved)
