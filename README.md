...
**Latest release:** v2.76.5 — 2026-09-17. Pairs with `control-ofc-daemon` ≥ v2.11.0. Individual features gate on newer daemons and say so in the app when one is missing; [CHANGELOG.md](CHANGELOG.md) records which version introduced each.
