...
**Latest release:** v2.59.0 — 2026-09-05. Pairs with `control-ofc-daemon` ≥ v2.11.0. Individual features gate on newer daemons and say so in the app when one is missing; [CHANGELOG.md](CHANGELOG.md) records which version introduced each.
