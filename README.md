...
**Latest release:** v2.4.0 — 2026-06-26. Pairs with `control-ofc-daemon` ≥ v2.2.0. See [`CHANGELOG.md`](CHANGELOG.md) for the full history.
...
- `pytest >= 8.0`, `pytest-qt >= 4.3`, `pytest-timeout >= 2.3`, `ruff >= 0.4`, `pip-audit >= 2.7`, `mutmut >= 2.5`
